function script_rfcn_VOC0712_ResNet50_rpn()
% script_rfcn_VOC0712_ResNet50_rpn()
...
% model
model                       = Model.ResNet50_for_RFCN_VOC0712();
% cache name
opts.cache_name             = 'rfcn_VOC0712_ResNet50_rpn_resnet50';
% config
